 ...
 *
 * Does nothing on a second call: the Rust side keeps one tray however many times it is asked,
 * which is what makes this safe to call from an effect that runs again every time a webview
 * reloads.
 *
