/**
 * The button. Vendored from shadcn/ui, the registry every element in this interface comes from.
 *
 * Everything below this header is the registry's own source, left exactly as it arrived so
 * that re-running `pnpm dlx shadcn@latest add button --overwrite` produces a diff a reviewer
