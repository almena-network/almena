/**
 * What the application says back after something happened. Vendored from shadcn/ui —
 ...
 * that re-running `pnpm dlx shadcn@latest add alert --overwrite` produces a diff a reviewer
